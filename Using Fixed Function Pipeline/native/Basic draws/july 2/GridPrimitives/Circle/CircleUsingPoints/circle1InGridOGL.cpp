...
void draw_circle(GLsizei size)
{
	...
	//we generate points by using trigonometric functions cosine and sine , increasing the angle gradually.

	glBegin(GL_POINTS);
		glColor3f(1.0f, 1.0f, 0.0f);

		for (angle = 0.0f; angle <= 2 * PI; angle += 0.0001f)
		{
