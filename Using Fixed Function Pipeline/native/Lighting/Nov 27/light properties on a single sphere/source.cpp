...
GLfloat light_diffuse_red[] = { 1.0f,0.0f,0.0f,1.0f };
GLfloat light_diffuse_green[] = { 0.0f,1.0f,0.0f,1.0f };
GLfloat light_diffuse_blue[] = { 0.0f,0.0f,1.0f,1.0f };

GLfloat spot_direction[] = { 0.0f,0.0f,-1.0f};
GLfloat spot_cutoff =  45.0f ;
GLfloat spot_exponent[] = { 0.2f };
GLfloat attenuation_constant[] = { 0.5f };
GLfloat attenuation_linear[] = { 0.2f };
GLfloat attenuation_quadratic[] = { 0.1f };


//GLfloat light_specular[] = { 1.0f,1.0f,1.0f,1.0f };
GLfloat light_position[] = { 1.0f,0.5f,1.0f,1.0f };
...
void initialize(void)
{
	...
	glLightfv(GL_LIGHT1, GL_CONSTANT_ATTENUATION, attenuation_constant);
	glLightfv(GL_LIGHT1, GL_LINEAR_ATTENUATION, attenuation_linear);
	glLightfv(GL_LIGHT1, GL_QUADRATIC_ATTENUATION, attenuation_quadratic);
