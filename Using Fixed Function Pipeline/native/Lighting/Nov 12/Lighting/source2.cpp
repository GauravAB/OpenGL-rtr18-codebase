...
GLfloat light_specular[] = { 1.0f,1.0f,1.0f,1.0f }; //again white light
GLfloat light_position[] = { 1.0f,1.0f,1.0f,1.0f };

GLfloat material_specular[] = { 1.0,1.0f,1.0f,1.0f };	//reflects white light
GLfloat material_shininess[] = { 50.0f };	//reflectance capacity
