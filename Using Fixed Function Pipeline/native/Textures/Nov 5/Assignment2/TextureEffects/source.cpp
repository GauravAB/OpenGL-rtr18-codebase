...
HGLRC ghrc;
GLuint SmileyTex;
GLfloat InsaneMode = 3.0f;

DWORD dwStyle;
WINDOWPLACEMENT wpPrev = { sizeof(WINDOWPLACEMENT) };

enum TweakSmiley { halfed, normalize, doubled, centered , insane };
...
void display(void)
{
	...
	switch (enumTS)
	{
		...
		case insane:
			glBegin(GL_QUADS);
			glTexCoord2f(0.0f, 0.0f); glVertex3f(-1.0f, -1.0f, 0.0f);
			glTexCoord2f(0.0f, InsaneMode); glVertex3f(-1.0f, 1.0f, 0.0f);
			glTexCoord2f(InsaneMode, InsaneMode); glVertex3f(1.0f, 1.0f, 0.0f);
			glTexCoord2f(InsaneMode, 0.0f); glVertex3f(1.0f, -1.0f, 0.0f);
			glEnd();
