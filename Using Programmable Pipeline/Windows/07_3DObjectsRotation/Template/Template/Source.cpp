...
void initialize(void)
{
	...
	glBindAttribLocation(glShadeModelrProgramObject, GAB_ATTRIBUTE_VERTEX, "vPosition");
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(float) * 36, pyramidColor, GL_STATIC_DRAW);
