...
void initialize(void)
{
	...
	glVertexAttribPointer(GAB_ATTRIBUTE_VERTEX, 2, GL_FLOAT, GL_FALSE, 0, NULL);
...

{
	...
	modelViewMatrix = modelViewMatrix * translate(0.0f, 0.0f, -4.0f);
	...
	glUniform1i(gNumberOfStripsUniform,4);
