...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR nCmdLine, int nCmdShow)
{
	...
	WNDCLASSEX wndclass;
	MSG msg;
	TCHAR szAppName[] = TEXT(" Two Shapes");
...
void initialize(void)
{
	...
	//6 step for square
	glGenBuffers(1, &gVboSquare);
	glBindBuffer(GL_ARRAY_BUFFER, gVboSquare);
...

{
	...
	modelViewMatrix = modelViewMatrix * translate(-1.2f, 0.0f, -4.0f);
	...
	modelViewMatrix = modelViewMatrix * translate(1.2f, 0.0f, -4.5f);
