...
{
	notex, onefourth , normal , onepoint , wrap,
...
void initialize(void)
{
	...
	LoadGLTextures(&gTextureSmiley, MAKEINTRESOURCE(MYBITMAP));
	glEnable(GL_TEXTURE);
...
void display(void)
{
	...
	case notex:
		...
		break;
	case onefourth:
		square_tex_coords[0] = 0.5f;
		square_tex_coords[1] = 0.5f;
		square_tex_coords[2] = 0.0f;
		square_tex_coords[3] = 0.5f;
		square_tex_coords[4] = 0.0f;
		square_tex_coords[5] = 0.0f;
		square_tex_coords[6] = 0.5f;
		square_tex_coords[7] = 0.0f;
		glBindBuffer(GL_ARRAY_BUFFER, gVbo_texture);
		glBufferData(GL_ARRAY_BUFFER, sizeof(square_tex_coords), square_tex_coords, GL_DYNAMIC_DRAW);
		glBindBuffer(GL_ARRAY_BUFFER,0);
		
		break;
	case normal:
		square_tex_coords[0] = 1.0f;
		square_tex_coords[1] = 1.0f;
		square_tex_coords[2] = 0.0f;
		square_tex_coords[3] = 1.0f;
		square_tex_coords[4] = 0.0f;
		square_tex_coords[5] = 0.0f;
		square_tex_coords[6] = 1.0f;
		square_tex_coords[7] = 0.0f;
		glBindBuffer(GL_ARRAY_BUFFER, gVbo_texture);
		glBufferData(GL_ARRAY_BUFFER, sizeof(square_tex_coords), square_tex_coords, GL_DYNAMIC_DRAW);
		glBindBuffer(GL_ARRAY_BUFFER, 0);
	...
	case onepoint:
		square_tex_coords[0] = 0.5f;
		square_tex_coords[1] = 0.5f;
		square_tex_coords[2] = 0.5f;
		square_tex_coords[3] = 0.5f;
		square_tex_coords[4] = 0.5f;
		square_tex_coords[5] = 0.5f;
		square_tex_coords[6] = 0.5f;
		square_tex_coords[7] = 0.5f;
		glBindBuffer(GL_ARRAY_BUFFER, gVbo_texture);
		glBufferData(GL_ARRAY_BUFFER, sizeof(square_tex_coords), square_tex_coords, GL_DYNAMIC_DRAW);
		glBindBuffer(GL_ARRAY_BUFFER, 0);
		break;
	case wrap:
		square_tex_coords[0] = 2.0f;
		square_tex_coords[1] = 2.0f;
		square_tex_coords[2] = 0.0f;
		square_tex_coords[3] = 2.0f;
		square_tex_coords[4] = 0.0f;
		square_tex_coords[5] = 0.0f;
		square_tex_coords[6] = 2.0f;
		square_tex_coords[7] = 0.0f;
		glBindBuffer(GL_ARRAY_BUFFER, gVbo_texture);
		glBufferData(GL_ARRAY_BUFFER, sizeof(square_tex_coords), square_tex_coords, GL_DYNAMIC_DRAW);
		glBindBuffer(GL_ARRAY_BUFFER, 0);
