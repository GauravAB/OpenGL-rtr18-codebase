...
void initialize(void)
{
	...
	gOrthographicProjectionMatrix = glm::mat4();
...
void display(void)
{
	...
	glUniformMatrix4fv(gMVPUniform, 1, GL_FALSE, &modelViewProjectionMatrix[0][0]);
...
void resize(int width, int height)
{
	...
	if (width <= height)
	{
		...
		gOrthographicProjectionMatrix = glm::ortho(-100.0f,100.0f,(-100.0f*(height/width)),(100.0f*(height/width)),-100.0f,100.0f);

	}
	else
	{

		gOrthographicProjectionMatrix = glm::ortho(-100.0f, 100.0f,(-100.0f*(width/height)), (100.0f*(width/height)), -100.0f, 100.0f);
	}
}
