...
/*
int Parser::getVertexCount(void)
{
	return Vertices;
}
int Parser::getTexturesCount(void)
{
	return Textures;
}
int Parser::getNormalsCount(void)
{
	return Normals;
}
int Parser::getMaxElements(void)
{
	return maxElements;
}
*/
...
void  Parser :: getModelVertexData (float **vertices, float **textures, float **normals, int** elements)
{
	...
	modelPositions = (float*)malloc(sizeof(float)*Vertices*3*9);

	modelNormals = (float*)malloc(sizeof(float)*Normals*3*9);

	modelTextures = (float*)malloc(sizeof(float)*Textures*2*6);

	processModelData();
	
	*vertices = modelPositions;
